      ...
      <form onSubmit={handleSubmit} className='flex text-sm sm:text[1rem] flex-col sm:flex-row gap-8'>
        <div className='flex flex-col gap-4 flex-1'>
          ...
          <div className='flex flex-wrap gap-6'>
            ...
            <div className='flex items-center gap-2'>
              <input value={formData.regularPrice} onChange={handleChange} className='p-3 border border-gray rounded-lg' type="number" id='regularPrice' min='50' max='1,000,000' required/>
              <div>
              <p>Regular price</p>
            ...
            {formData.offer &&(
            <div className='flex items-center gap-2'>
              <input value={formData.discountedPrice} onChange={handleChange} className='p-3 border border-gray rounded-lg' type="number" id='discountedPrice' min='0' max='1,000,000' required/>
              <div>
              <p>Discount price</p>
              <span className='text-xs'>($ /month)</span>
              </div>
        ...
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <div className='flex gap-4'>
            ...
            <button type='button' onClick={handleImageSubmit} disabled={imageUploading} className='p-3 text-green-700 text-xs sm:text-[1rem] border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80'>{imageUploading ? 'Uploading...' : 'Upload'}</button>
          </div>
        ...
        <button disabled={loading || imageUploading} className='p-3 text-xs sm:text-[1rem] bg-slate-700 text-white rounded-lg uppercase hover:opacity-80 disabled:opacity-80'>
