...
const SearchPage = () => {
  ...
  return (
    <div className='flex flex-col md:flex-row'> 
      <div className='mt-16 p-7 border-b-2 md:border-r-2 md:min-h-screen'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
          ...
          <div className='flex gap-2 flex-wrap items-center'>
            ...
            <div className='flex gap-2'>
              <input onChange={handleChange} checked={sidebarData.furnished === true} type="checkbox" id="furnished" className='w-5'/>
              <span>Furnished</span>
            </div>
          </div>
          <div className='flex items-center gap-2'>
